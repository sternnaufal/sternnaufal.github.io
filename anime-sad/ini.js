...
document.getElementById("bq").onclick = function() {
  ...
  function kalimatakhir(){
      ...
      kalimat.innerHTML="";
  	new TypeIt("#kalimat", {
      strings: ["" + pesanAkhir1], startDelay: 10, speed: 60, cursor: true,
  ...
  strings: ["" + pesanAkhir3], startDelay: 100, speed: 60, cursor: false, deleteSpeed: 20, breakLines: false, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
  ...
  var { value: jawaban } = await swals.fire({
    title: 'Isi Pesan Untukku &#document.getElementById("loveIn").onclick = function() {
      if(fungsiAwal==0){
        audio.play();
        loveIn.style="transition:all .8s ease;transform:scale(15);opacity:0";
        ftAwal.style="opacity:0";
...
document.getElementById("bq").onclick = function() {
  ...
  if(jawaban && jawaban.length < 100){
    ...
    window.location = "https://api.whatsapp.com/send?phone=083174139326&text=" + pesanwhatsapp +" //bot By Sternnaufal";
    tombol();
  } else {
